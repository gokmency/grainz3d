  ...
  return (
    <AuthPageLayout>
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Hesap Oluştur</h1>
        <p className="text-muted-foreground text-sm">
          Parametrik konfigüratöre erişmek için kayıt olun
        </p>
      </div>
      ...
      <form action={async () => { await signInWithGoogle('/dashboard') }}>
        <Button
          type="submit"
          variant="outline"
