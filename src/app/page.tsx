...
const COPY = {
  en: {
    ...
    benefits: {
      ...
      subtitle:
        "Built on modern 3D web standards, Parametric Design (Demo) gives you everything needed to deliver professional configuration experiences—from prototype to production.",
      items: [
        {
          icon: "zap",
      ...
      items: [
        {
          ...
          a: "Yes. Parametric Design (Demo) runs entirely in modern web browsers—Chrome, Firefox, Safari, Edge. No downloads, no plugins, no installation. Users open a link and start configuring parametric 3D models immediately.",
        },
        {
    ...
    footer: {
      product: "Parametrik Tasarım (Demo)",
  ...
  tr: {
    ...
    benefits: {
      ...
      subtitle:
        "Modern web ve 3D teknolojileri üzerine kurulu Parametrik Tasarım (Demo), prototipten üretime profesyonel yapılandırma deneyimleri sunmak için ihtiyacınız olan her şeyi sağlar.",
      items: [
        {
          icon: "zap",
          title: "Gerçek Zamanlı Parametrik Güncellemeler",
          description:
            "Her parametre değişikliği anında görsel geri bildirim tetikler. 3D modeliniz anında yeniden hesaplanır—sayfa yenilemesi veya bekleme yok.",
        },
        {
          icon: "globe",
      ...
      items: [
        {
          ...
          a: "Evet. Parametrik Tasarım (Demo) tamamen modern web tarayıcılarında—Chrome, Firefox, Safari, Edge—çalışır. İndirme yok, eklenti yok, kurulum yok. Kullanıcılar bir link açar ve parametrik 3D modelleri hemen yapılandırmaya başlar.",
        },
        {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      />
        ...
        {/* Footer with SEO reference to grainzdigital.com */}
        <footer className="relative z-10 border-t border-white/10 bg-black/80 backdrop-blur-md">
          <div className="relative z-10 container mx-auto px-4 py-12">
            <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-white/70">
                <span className="text-sm font-semibold tracking-wide text-white">{t.footer.product}</span>
                ...
                <span className="text-xs text-zinc-400">
                  ...
                  <a
                    ...
                    title="Grainz Digital - Web & 3D Dijital Ajans (grainzdigital.com)"
                  >
                    grainzdigital.com
                  </a>
                </span>
