...
const ENVIRONMENT_OPTIONS: EnvironmentOption[] = [
  {
    id: 'default_studio',
    name: 'Standart Stüdyo',
    icon: <Sparkles className="w-4 h-4" />,
    value: 'DEFAULT_STUDIO',
    description: 'Standart stüdyo ışıklandırması',
  },
  {
    id: 'photo_studio',
    ...
    value: 'PHOTO_STUDIO',
    description: 'Profesyonel ürün fotoğrafı aydınlatması',
  },
  {
    id: 'furniture_studio',
    name: 'Mobilya Stüdyosu',
    icon: <Sparkles className="w-4 h-4" />,
    value: 'FURNITURE_STUDIO',
    description: 'Mobilya ve iç mekan ürünleri için optimize',
  },
  {
    id: 'jewelry_studio',
    name: 'Mücevher & Obje Stüdyosu',
    icon: <Sparkles className="w-4 h-4" />,
    value: 'JEWELRY_STUDIO',
    description: 'Yüksek parlaklık ve yansıma modu',
  },
  {
    id: 'neutral',
    name: 'Doğal Nötr Işık',
    icon: <Moon className="w-4 h-4" />,
    value: 'NEUTRAL',
    description: 'Dengeli nötr ışıklandırma',
  },
  {
    id: 'colorful_studio',
    name: 'Renkli & Canlı Stüdyo',
    icon: <Sparkles className="w-4 h-4" />,
    value: 'COLORFUL_STUDIO',
    description: 'Canlı ve kontrastlı stüdyo ortamı',
  },
  {
    id: 'venice_sunset',
    name: 'Gün Batımı (Sunset)',
    icon: <Sun className="w-4 h-4" />,
    value: 'VENICE_SUNSET',
    description: 'Sıcak altın saat ambiyansı',
  },
  {
    id: 'green_point_park',
    name: 'Açık Hava Parkı',
    icon: <TreePine className="w-4 h-4" />,
    value: 'GREEN_POINT_PARK',
    description: 'Doğal gün ışığı ortamı',
  },
  {
    id: 'snowy_field',
    name: 'Karlı Alan',
    icon: <Moon className="w-4 h-4" />,
    value: 'SNOWY_FIELD',
    description: 'Kış açık hava sahnesi',
  },
  {
    id: 'wide_street',
    name: 'Şehir Caddesi',
    ...
    value: 'WIDE_STREET',
    description: 'Kentsel mimari sahne',
  },
];
