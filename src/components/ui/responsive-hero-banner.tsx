  ...
  return (
    <section className="w-full isolate min-h-screen overflow-hidden relative">
      ...
      <header className="z-10 xl:top-4 relative pt-4">
          ...
          <div className="flex items-center justify-between pt-4">
            {logoUrl ? (
              ...
              <div className="flex items-center gap-2">
                <span className="text-xl font-bold text-white tracking-tight">Parametrik Tasarım</span>
                <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 font-normal border border-emerald-500/30">
                  Demo
                </span>
              </div>
            )}
        ...
        >
          <div
            className={`flex flex-col p-6 h-full transition-transform duration-300 ${
      ...
      <div className={`z-10 relative transition-opacity duration-300 ${mobileMenuOpen ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
