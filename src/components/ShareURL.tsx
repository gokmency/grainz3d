            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <span>{showQR ? 'QR Kodu Gizle' : 'QR Kodu Göster'}</span>
                </button>
                ...
                <div className="space-y-2">
                  {!showSavePreset ? (
                    ...
                    >
                      ...
                      <span>Hazır ayar olarak kaydet</span>
                    </button>
                  ) : (
                    <div className="space-y-2">
                      <input
                      ...
                      {saveStatus === 'success' && (
                        <p className="text-xs text-emerald-400">Hazır ayar kaydedildi!</p>
                      )}
                      {saveError && (
              ...
              <div className="p-3 bg-zinc-800/50 rounded-lg">
                <p className="text-xs text-zinc-500">
                  Bu bağlantı güncel 3D tasarım parametrelerinizi içerir. Bu linke sahip herkes özelleştirdiğiniz modeli görebilir.
                </p>
              </div>
            </div>
